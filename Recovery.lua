...
DDLIVESL = 26234 + 1325 + 1 -- Doomsday team lives local
...
CPPCCl = 32349 + 3 -- cayo perico plasma cutter cut local 
...
CPLIVESL = 62851 + 1109 + 1 -- Cayo Perico team lives local
...
AUAJg1 = FMg + 9184 -- apartment unlock all jobs global 1
AUAJg2 = FMg + 9189 -- apartment unlock all jobs global 2
AUAJg3 = FMg + 9196 -- apartment unlock all jobs global 3
AUAJg4 = FMg + 9202 -- apartment unlock all jobs global 4
AUAJg5 = FMg + 9208 -- apartment unlock all jobs global 5
...
AHDg = 4718592 + 3771
AHLIVES = 26234 + 1325 + 1 -- Apartment Heist team lives local
...
DCLIVESL = 26234 + 1325 + 1 -- diamond casino team lives local
...
-- Nightclub Variables
NLSCg = FMg + 23769 -- night loop safe capacity global
NLISg = FMg + 23746 -- night loop income start global
NLIEg = FMg + 23765 -- night loop income end global
NLCl = 213 + 32 + 19 + 1 -- night loop collect local
NLTl = 213 + 32 + 2 -- night safe type local
NCVg = 1845298

-- Special Cargo Variables
SCVMTl = 574 + 7 		-- special cargo vip mission type local
SCVISl = 574 + 1 		-- special cargo vip instant sell local
...
CUg = 2709274 -- collectibles unlocker global
...
-- Casino
CRS = 1379
CCBL0 = FMg + 26623 -- Casino Chips Buy Limit
CCBL1 = FMg + 26624 -- Casino Chips Buy Limit

-- Cayo Extra
PSV = FMg + 29552 -- Panther Statue
PDIAMOND = FMg + 29550 -- Pink Diamond
BB = FMg + 29549 -- Bearer Bonds
RN = FMg + 29548 -- Ruby Necklace
TEQUILA = FMg + 29547 -- Tequila
BAS1 = FMg + 29300 -- Bag Size

-- Kortz Center Heist Variables
KCBRL = 597 -- kortz center reload board local
KCDCL = 1386 -- Data crack local
KCFHL = 26464 -- Fingerprint hack local
KCAC_BASE = 32416 + 1 -- Access code base
KCLGL = 70416 -- Lasers local
KCVLL = 27512 -- Vault door local
KCCGL_BASE = 32453 + 1 -- Cut glass base
KCCGL_OFFSET = 3 -- Cut glass offset
KCPT_STATE = 28953 + 11 -- Primary target state
KCST_STATE = 28953 + 11 -- Secondary target state
...
KCSECONDARY_BASE = 4980736 + 1 + 29174 -- Secondary targets base
...
-- Globale CutsPresetter Funktion (wird von mehreren Heists verwendet)
...
local globalFix = SN_Manager:add_checkbox("Fix Global Rank")
local rpLevel = SN_Manager:add_input_int("Rank")
...
local level = SN_Manager:add_input_int("Rank")
SN_Manager:add_button("Set Slot 1 Crew Rank", function()
...
SN_Manager:add_button("Set Slot 2 Crew Rank", function()
	local rankValue = rpLevel:get_value()
...
SN_Manager:add_button("Set Slot 3 Crew Rank", function()
	local rankValue = rpLevel:get_value()
...
SN_Manager:add_button("Set Slot 4 Crew Rank", function()
	local rankValue = rpLevel:get_value()
...
SN_Manager:add_button("Set Slot 5 Crew Rank", function()
	local rankValue = rpLevel:get_value()
...
local SN_Self = SN_Manager:add_tab("Self Menu ")
AGCT = SN_Self:add_checkbox("Unlock Gender Change")
...
RTPT = SN_Self:add_checkbox("Remove Transaction Error")
...
SN_Self:add_button("Remove Published And Players Job Liked To You", function()
...
SN_Self:add_button("Remove Orbital Cannon Cooldown", function()
	stats.set_int(MPX() .. "ORBITAL_CANNON_COOLDOWN", 0)
end)
SN_Self:add_button("Refill Nightclub Popularity", function()
	stats.set_int(MPX() .. "CLUB_POPULARITY", 1000)
end)
SN_Self:add_button("Refill Inventory/Armour", function()
...
SN_Self:add_button("Refill Inv/Armour x1000", function()
...
SN_Self:add_separator()
SN_Self:add_text("Bad Sport!")
BadSportCombo = 0
SN_Self:add_imgui(function()
...
SN_Self:add_sameline()
SN_Self:add_button("Execute", function()
...
local SN_Reports = SN_Manager:add_tab("Reports Menu ")
SN_Reports:add_imgui(function()
...
SN_CasinoHeist:add_separator()
SN_CasinoHeist:add_text("Extras")
local casinoAutograbber = SN_CasinoHeist:add_checkbox("Autograbber")
...
SN_CasinoHeist:add_button("Skip Setup", function()
    ...
    stats.set_int(MPX() .. "H3OPT_BITSET1", -1)
    stats.set_int(MPX() .. "H3OPT_COMPLETEDPOSIX", -1)
    gui.show_message("Diamond Casino Heist", "Arcade Setups should've been skipped. Don't forget to change the session.")
end)
...
SN_Doomsday:add_button("Act I: Data Breaches",
function ()
	DoomsdayActSetter(503, 229383)
end)
SN_Doomsday:add_sameline()
SN_Doomsday:add_button("Act II: Bogdan Problem",
function ()
	DoomsdayActSetter(240, 229378)
end)
SN_Doomsday:add_sameline()
SN_Doomsday:add_button("Act III: Doomsday Scenario",
function ()
...
function ()
	...
	gui.show_message("YOUR CAYO BAG SIZE HAS BEEN SET TO THE VALUE "..cayobag:get_value().." SUCCESSFULLY") 
end)
...
local SN_CayoExtra = SN_Cayo:add_tab("Size/Value Editor ")
SN_CayoExtra:add_text("Bag Size Editor")
bagSizeVal = 1800
SN_CayoExtra:add_imgui(function()
...
SN_CayoExtra:add_text("Custom Bag Size Editor")
...
SN_CayoExtra:add_separator()
SN_CayoExtra:add_text("Primary Target Editors")
...
SN_CayoExtra:add_separator()
SN_CayoExtra:add_text("Secondary Target Editors")
goldSizeVal = 45375
SN_CayoExtra:add_imgui(function()
...
SN_CayoExtra:add_text("These values seem incorrect, but the game reads them properly.")
SN_CayoExtra:add_text("Minimum values are exact defaults for ALL targets.")
SN_CayoExtra:add_separator()
SN_CayoExtra:add_text("Press this after setting values.")
SN_CayoExtra:add_button("Reset Kosatka Board", function()
	locals.set_int(HIP, 1566, 2)
	gui.show_message("Cayo Heist", "Planning board has been reset!")
end)

-- Kortz Center Heist --
local SN_Kortz = SN_Heist_Editor:add_tab("Kortz Center Heist ")
...
local selectedPayoutTarget = 0
local autoHacks = false
local dataCrackTriggered = false
local fingerprintTriggered = false
local vaultDoorTriggered = false
local heistWasActive = false
...
SN_Kortz:add_imgui(function()
    ...
    if targetIdx >= 1 and targetIdx <= 27 then
        ...
        if ImGui.Button("2x") then
            setPayout(targetIdx, targetBasePayouts[targetIdx] * 2)
            gui.show_message("Kortz Center", "Payout set to 2x")
        end
        ImGui.SameLine()
        if ImGui.Button("3x") then
            setPayout(targetIdx, targetBasePayouts[targetIdx] * 3)
            gui.show_message("Kortz Center", "Payout set to 3x")
        end
        ImGui.SameLine()
        if ImGui.Button("5x") then
            setPayout(targetIdx, targetBasePayouts[targetIdx] * 5)
            gui.show_message("Kortz Center", "Payout set to 5x")
        end
        ImGui.SameLine()
        if ImGui.Button("Reset") then
            setPayout(targetIdx, targetBasePayouts[targetIdx])
            gui.show_message("Kortz Center", "Payout reset to default")
        end
    end
    ImGui.Separator()
    ...
    if ImGui.Button("2x All Targets") then
        for i = 1, 27 do
            setPayout(i, targetBasePayouts[i] * 2)
        end
        gui.show_message("Kortz Center", "All targets set to 2x!")
    end
    ImGui.SameLine()
    if ImGui.Button("3x All Targets") then
        for i = 1, 27 do
            setPayout(i, targetBasePayouts[i] * 3)
        end
        gui.show_message("Kortz Center", "All targets set to 3x!")
    end
    ImGui.SameLine()
    if ImGui.Button("Reset All Payouts") then
        ...
        gui.show_message("Kortz Center", "All payouts reset!")
    end
    ImGui.Separator()
    ...
    bagSizeValue, _ = ImGui.InputInt("Bag Size", bagSizeValue)
    if ImGui.Button("Set Bag Size") then
        if bagSizeValue < 1 then
            gui.show_message("Kortz Center", "Bag size must be at least 1!")
        else
            globals.set_int(KCBGL, bagSizeValue)
            gui.show_message("Kortz Center", "Bag capacity set to " .. bagSizeValue)
        end
    end
    
    livesValue, _ = ImGui.InputInt("Team Lives", livesValue)
    if ImGui.Button("Set Lives") then
        if livesValue < 1 then
            gui.show_message("Kortz Center", "Lives must be at least 1!")
        else
            locals.set_int("fm_mission_controller_v3", KCLIVESL, livesValue)
            gui.show_message("Kortz Center", "Team lives set to " .. livesValue)
        end
    end
    ...
    if ImGui.Button("Skip Cooldown") then
        ...
        gui.show_message("Kortz Center", "Cooldowns reset!")
    end
    ImGui.SameLine()
    if ImGui.Button("Reload Board") then
        locals.set_int("kortz_planning", KCBRL, 2)
        gui.show_message("Kortz Center", "Planning board reloaded!")
    end
    ImGui.Separator()
    
    -- Preps
    ImGui.TextColored(1.0, 0.8, 0.2, 1.0, "PREPS")
    if ImGui.Button("Complete All Preps") then
        ...
        gui.show_message("Kortz Center", "All preps completed!")
    end
    ImGui.SameLine()
    ...
    if ImGui.Button("Scope All Secondary Targets") then
        stats.set_int(MPX() .. "K26_SCOPING_BS", -1)
        gui.show_message("Kortz Center", "All secondary targets scoped!")
    end
    ImGui.SameLine()
    if ImGui.Button("Enable Solo Secondary Targets") then
    ...
    if ImGui.Button("Skip Cutscene") then
        SkipCutscene()
        gui.show_message("Kortz Center", "Cutscene skipped!")
    end
    ImGui.SameLine()
    if ImGui.Button("Instant Finish") then
        locals.set_int("fm_mission_controller_v3", KCIf1, 51338752)
        locals.set_int("fm_mission_controller_v3", KCIf2, 50)
        gui.show_message("Kortz Center", "Heist finished!")
    end
    ImGui.SameLine()
    if ImGui.Button("Skip Data Crack") then
        if isKortzHeistActive() then
            ...
            gui.show_message("Kortz Center", "Data crack bypassed!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
    ImGui.SameLine()
    if ImGui.Button("Skip Fingerprint") then
        if isKortzHeistActive() then
            locals.set_int("fm_mission_controller_v3", KCFHL, 5)
            gui.show_message("Kortz Center", "Fingerprint bypassed!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
    ImGui.SameLine()
    if ImGui.Button("Skip Vault Door") then
        if isKortzHeistActive() then
            locals.set_int("fm_mission_controller_v3", KCVLL, 5)
            gui.show_message("Kortz Center", "Vault door bypassed!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
    ...
    if ImGui.Button("Cut All Glass") then
        if isKortzHeistActive() then
            ...
            gui.show_message("Kortz Center", "All glass cases cut!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
    ...
    if ImGui.Button("Take Primary Target") then
        if isKortzHeistActive() then
            ...
            gui.show_message("Kortz Center", "Primary target acquired!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
    ...
    if ImGui.Button("Take Secondary Target") then
        if isKortzHeistActive() then
            ...
            gui.show_message("Kortz Center", "Secondary target secured!")
        else
            gui.show_message("Kortz Center", "Heist not active!")
        end
    end
...
-- Flash Ops
SN_Flash_Ops = SN_Heist_Editor:add_tab("Flash Ops ")
...
local sContract = 0
local SN_Agency = SN_Flash_Ops:add_tab("Agency ")
...
-- Autoshop tab
local SN_Autoshop = SN_Flash_Ops:add_tab("Autoshop ")
...
SN_Autoshop:add_separator()
SN_Autoshop:add_text("Team Lives:")
local livesValueAuto = 3
SN_Autoshop:add_imgui(function()
    livesValueAuto, _ = ImGui.InputInt("##AutoLives", livesValueAuto)
    if ImGui.Button("Set Lives##Auto") then
        if livesValueAuto < 1 then
            gui.show_message("Autoshop", "Lives must be at least 1!")
        else
            gui.show_message("Autoshop", "Team lives set to " .. livesValueAuto)
        end
    end
end)
...
-- Salvage Yard --
local SN_Salvage = SN_Flash_Ops:add_tab("Salvage Yard ")
local SalvageYard = {
    robberies = {
...
local SN_Cluck = SN_Flash_Ops:add_tab("Cluckin Bell Heist ")
...
local SN_BusinessT = Silent:add_tab("Business Tab ")

-- Bunker --

local SN_Bunker = SN_BusinessT:add_tab("Bunker ")
...
local SN_MB = SN_BusinessT:add_tab("MC Businesses ")
...
-- Ceo Warehouse --
local SN_CeoWarehouse = SN_BusinessT:add_tab("Ceo Warehouse ")
CEO1 = FMg + 15821 --("EXEC_CONTRABAND_SALE_VALUE_THRESHOLD1")
CEO2 = FMg + 15588 --("EXEC_BUY_COOLDOWN")
CEO3 = FMg + 15589 --("EXEC_SELL_COOLDOWN")
...
cratevalue = 0
SN_CeoWarehouse:add_imgui(function()
...
checkbox = SN_CeoWarehouse:add_checkbox("Start Ceo Manager")

PRPGD = SN_CeoWarehouse:add_checkbox("Disable Player RP Gain")
...
SN_CeoWarehouse:add_button("Open Warehouse Screen", function()
...
SN_CeoWarehouse:add_separator()
SN_CeoWarehouse:add_text("WareHouse Data Editor")
SN_CeoWarehouse:add_button("Reset Crate Sell Stats-0/0 Sales", function()
...
-- Night Loop --
local SN_Nightclub = SN_BusinessT:add_tab("Nightclub ")
...
-- Arcade loop - 
local SN_arcade = SN_BusinessT:add_tab("Arcade ")
...
-- Hangar Cargo --
local SN_Hangar = SN_BusinessT:add_tab("Hangar Cargo ")
...
-- Special Cargo --
local SN_Special = SN_BusinessT:add_tab("Special Cargo ")
...
-- Air Cargo --
local SN_Air = SN_BusinessT:add_tab("Air Cargo ")
CARGO1 = FMg + 22581
CARGO2 = FMg + 22582
CARGO3 = FMg + 22583
CARGO4 = FMg + 22584
...
CARGO8 = FMg + 22588
CARGO9 = FMg + 22589
local hanvalue = SN_Air:add_input_int("Crate Value")
SN_Air:add_button("Set Value", function()
...
SN_Air:add_separator()
RCRT = SN_Air:add_checkbox("Remove Ron's Cut")
...
SN_Air:add_separator()
PRPGD = SN_Air:add_checkbox("Disable Player RP Gain")
script.register_looped("PlayerRPGainDisabler", function(script)
	script:yield()
	if PRPGD:is_enabled() then
		globals.set_float(FMg + 1, 0)
...
SN_Air:add_separator()
SN_Air:add_button("Open Hangar Screen", function()
	SCRIPT.REQUEST_SCRIPT("apparcadebusinesshub")
	SYSTEM.START_NEW_SCRIPT("apparcadebusinesshub", 8344)
end)
SN_Air:add_separator()
SN_Air:add_text("Air Cargo Editor")
SN_Air:add_button("Reset Crate Sell Stats-0/0 Sales", function()
...
-- Miscellaneous --
local SN_unlocker = Silent:add_tab("Unlocker Menu ")
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Unlock Removed Vehicles",
function ()
...
SN_unlocker:add_separator()
SN_unlocker:add_text("Unlock all Awards")
SN_unlocker:add_button("Victory", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("General", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Weapons", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Crimes", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Vehicles", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Combat", function()
...
SN_unlocker:add_separator()
SN_unlocker:add_text("Unlock all Heist Awards")
SN_unlocker:add_button("Unlock All Apartment Heists Awards", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Unlock All Diamond Casino Heist Awards", function()
	stats.set_int(MPX() .. "CAS_HEIST_NOTS", -1)
	stats.set_int(MPX() .. "CAS_HEIST_FLOW", -1)
...
SN_unlocker:add_button("Unlock All Cayo Heist Awards", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Unlock All Doomsday Heist Awards", function()
...
SN_unlocker:add_separator()
SN_unlocker:add_text("Unlock all DLC Awards")
SN_unlocker:add_button("A Safehouse In The Hills", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Agents of Sabotage", function()
	for i = 9542, 9546 do
		stats.set_packed_stat_bool(i, true)
	end
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("After Hours", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Arena War", function()
...
SN_unlocker:add_button("Diamond Casino n Resort", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Arcade", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("LS Summer Special", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("LS Tuners", function()
...
SN_unlocker:add_sameline()
SN_unlocker:add_button("Contract", function()
...
-- LSCM ---
local SN_LSCM = SN_unlocker:add_tab("LSCM Unlocker Menu ")
...
-- Account Unlocker Menu ---
local SN_ACC = SN_unlocker:add_tab("Account Unlocker Menu ")
SN_ACC:add_button("Unlock WM 29 Pistol", function()
...
SN_ACC:add_button("Unlock The Shocker", function()
...
SN_ACC:add_button("Unlock The Snowball Launcher", function()
...
SN_ACC:add_button("Complete All Daily & Weekly Challenges", function()
	script.run_in_fiber(function(script)
...
local SN_Casino = Silent:add_tab("Casino ")
SN_Casino:add_text("Casino Chips")
chipsVal = 1800
...
SN_Casino:add_button("Bypass Casino Cooldown", function()
...
SN_Casino:add_text("Winning too much too quickly might get you banned, enable this at your own risk.")
...
-- Tunables --
local SN_TunMenu = Silent:add_tab("Tunables ")
local currentapmultiplier = globals.get_float(FMg + 25489)
SN_TunMenu:add_text("AP")
SN_TunMenu:add_text("Your AP Multiplier is " .. currentapmultiplier)
local apmvalue = SN_TunMenu:add_input_float("AP")
SN_TunMenu:add_button("Set Money Multiplier", function()
...
SN_TunMenu:add_separator()
local currentsrmultiplier = globals.get_float(FMg + 25489)
SN_TunMenu:add_text("Street Races")
SN_TunMenu:add_text("Your Street Races Multiplier is " .. currentsrmultiplier)
local srmvalue = SN_TunMenu:add_input_float("Street Races")
SN_TunMenu:add_button("Set Money Multiplier", function()
...
-- No Needs --
local SN_NoNeed = Silent:add_tab("Extra ")
...
SN_NoNeed:add_button("Remove Dax Fooligan missions CoolDown ", function()
    stats.set_int(MPX() .. "XM22JUGGALOWORKCDTIMER", -1)
end)
SN_NoNeed:add_button("Remove VIP/MC Cooldown", function()
	stats.set_int("MPPLY_VIPGAMEPLAYDISABLEDTIMER", 0)
end)
SN_NoNeed:add_button("Skip Yacht Missions", function()
